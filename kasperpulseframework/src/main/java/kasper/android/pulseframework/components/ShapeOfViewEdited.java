...
public class ShapeOfViewEdited extends FrameLayout {
    ...
    public ShapeOfViewEdited(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public ShapeOfViewEdited(@NonNull Context context, boolean noShadow) {
        super(context);
        this.noShadow = noShadow;
        init(context, null);
    }

    public ShapeOfViewEdited(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ShapeOfViewEdited(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
