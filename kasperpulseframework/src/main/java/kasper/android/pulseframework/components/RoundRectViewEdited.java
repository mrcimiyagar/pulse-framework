...
public class RoundRectViewEdited extends ShapeOfViewEdited {
    ...
    public RoundRectViewEdited(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public RoundRectViewEdited(@NonNull Context context, boolean noShadow) {
        super(context, noShadow);
        init(context, null);
    }

    public RoundRectViewEdited(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundRectViewEdited(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
